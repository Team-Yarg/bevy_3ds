use crate::{
    axis::{Axis3ds, Axis3dsType},
    button::{Button3ds, Button3dsType},
};
use bevy::{
    app::{Plugin, Update},
    ecs::system::Res,
...
fn button_text_system(buttons: Res<Input<Button3ds>>, axis: Res<Axis<Axis3ds>>) {
    ...
    for button in pressed_buttons {
        if matches!(
            button.button_type,
            Button3dsType::CPadUp
                | Button3dsType::CPadLeft
                | Button3dsType::CPadRight
                | Button3dsType::CPadDown
        ) {
